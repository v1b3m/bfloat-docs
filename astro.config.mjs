...
export default defineConfig({
	integrations: [
		starlight({
			...
			description: 'Comprehensive developer documentation for the bfloat LLM-powered React Native app generator platform.',
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/bfloat/bfloat-app-engineer' },
			],
			customCss: [
			...
			sidebar: [
				{
					...
					items: [
						...
						{ label: 'Project Overview', slug: 'getting-started/project-overview' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'React Native Generation', slug: 'core-concepts/react-native-generation' },
